...
function Signup() {
  ...
  const inputBase =
    "w-full rounded-xl border bg-slate-950/50 px-4 py-3 text-sm text-slate-100 placeholder:text-slate-400 outline-none transition focus:ring-2 focus:ring-cyan-500/60 focus:border-cyan-500/40";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        {/* subtle grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(56,189,248,0.08)_1px,transparent_1px),linear-gradient(to_bottom,rgba(56,189,248,0.08)_1px,transparent_1px)] bg-size-[36px_36px] opacity-40 mask-[radial-gradient(ellipse_at_center,black_55%,transparent_75%)]" />
      </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/3 p-6 shadow-[0_0_60px_rgba(34,211,238,0.08)] backdrop-blur">
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-slate-300">
              Join EcoTrack and start tracking your impact.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`${inputBase} ${fieldErrors?.name ? errorRing : "border-white/10"}`}
                autoComplete="name"
                disabled={isLoading}
              />
              {fieldErrors?.name ? (
            ...
            <div>
              ...
              <input
                ...
                className={`${inputBase} ${fieldErrors?.email ? errorRing : "border-white/10"}`}
                autoComplete="email"
                disabled={isLoading}
              />
              {fieldErrors?.email ? (
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
                className={`${inputBase} ${fieldErrors?.password ? errorRing : "border-white/10"}`}
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
                className={`${inputBase} ${
                  fieldErrors?.confirmPassword ? errorRing : "border-white/10"
                }`}
                autoComplete="new-password"
                disabled={isLoading}
              />
